function filterJSON(json, key, value) {
  ...
  var color = d3.scale.ordinal().range(["#0000FF",  "#FF0000", "#00FF00","#FFFF00"]);
  ...
  function updateGraph(data) {
      ...
      y.domain([d3.min(data, function(d) { return d.value*.99; }), d3.max(data, function(d) { return d.value*1.01; })]);
